  ...
  return (
    <nav className="navbar navbar-expand-lg bg-body-tertiary">
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse justify-center items-center w-7/12" id="navbarSupportedContent">
          ...
          <div className="text-black text-lg border-2 border-blue-500 rounded-lg m-2 p-2">
